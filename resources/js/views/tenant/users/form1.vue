        ...
        <form autocomplete="off" @submit.prevent="submit">
            <div class="form-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4" v-if="typeUserSelected!='client'">
                        <div
...
<script>
export default {
    props: {showDialog: {required: false}, recordId: {required: false}, typeUser:{required: false}, typeUserSelected:{default: null},external : {default: false}},
    data() {
        return {
            defaultProps: {
                children: "childrens",
    ...
    methods: {
        ...
        filterTypeUser(){
            if(this.typeUserSelected) {
                this.types = _.filter(this.all_types, {'type': this.typeUserSelected});
                this.form.type = this.typeUserSelected
            }else {this.types = this.all_types;}
        },
        initForm() {
            this.errors = {};
            this.form = {
            ...
            this.$http
                ...
                .then((response) => {
                    if (response.data.success) {
                        ...
                        if (this.external) {
                            this.$eventHub.$emit('reloadDataUsers', response.data.data)
                        } else {
