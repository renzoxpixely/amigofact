...
<!--                            <el-checkbox v-model="form.fixed_asset">Activo fijo-->
<!--                            </el-checkbox>-->
<!--                        </div>-->
<!--                    </div>-->
                </div>
                <div class="row">
                    ...
                    <div v-if="isImport" class="col-lg-2">
                    ...
                    <div class="col-lg-2" v-if="!isImport">
                ...
                <div class="row">
                    ...
                    <div v-if="isImport" class="col-lg-4">
                        <div :class="{'has-danger': errors.attached_documents}"
                             class="form-group">
                            <label class="control-label">Adjuntar documentos</label>
                            <el-input
                                v-model="form.attached_documents"
                                type="file"
                            ></el-input>

                            <small v-if="errors.attached_documents"
                                   class="form-control-feedback"
                                   v-text="errors.attached_documents[0]"></small>
                        </div>
                    </div>

                    <div class="col-lg-4" v-if="isImport">
                    ...
                    <div v-if="!isImport" class="col-lg-4 mt-4">
                ...
                <div class="row" v-if="form.has_import">
                    <div class="col-lg-2">
                    ...
                    <div class="col-lg-2">
                        <div :class="{'has-danger': errors.red_liquidation}"
                             class="form-group">
                            <label class="control-label">Ref. liquidation</label>
                            <el-input v-model="form.red_liquidation"
                            ></el-input>

                            <small v-if="errors.red_liquidation"
                                   class="form-control-feedback"
                                   v-text="errors.red_liquidation[0]"></small>
                        </div>
                    </div>
                    <div class="col-lg-2">
                    ...
                    <div class="col-lg-2">
                        <div :class="{'has-danger': errors.transport_code}"
                             class="form-group">
                            <label class="control-label">Código de embarque</label>
                          <el-input
                ...
                <div class="row justify-content-end" v-if="form.has_import">

                </div>

                <div class="row">
<!--                    <div class="col-md-12 mt-2 mb-2 justify-content-between">-->
                        <div v-if="!isImport" class="form-group col-lg-4">
...
<!--                    </div>-->
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-md-6 d-flex align-items-end mt-4">
                        <div class="form-group">
                            <button v-if="form.has_import" class="btn waves-effect waves-light btn-primary"
                                    type="button"
                                    @click.prevent="clickAddInvoice">+ Agregar Invoice
                            </button>
                            <button v-else class="btn waves-effect waves-light btn-primary"
                                    type="button"
                ...
                <div v-if="form.items.length"
                            ...
                            <table class="table">
                                ...
                                <tr v-for="(row, index) in form.items"
                                    ...
                                    <td class="text-right">
                                        ...
                                        <button class="btn waves-effect waves-light btn-xs btn-danger"
                                                type="button"
                                                @click.prevent="clickRemoveItem(index)"><i class="fa fa-times"></i>
                                        </button>
                                    </td>
                                </tr>
                                </tbody>
                    ...
                    <div class="col-md-12">
                        <p v-if="form.total_exportation > 0"
                            class="text-right m-0">OP.EXPORTACIÓN: {{ currency_type.symbol }}
                                                                {{ form.total_exportation }}</p>
                        <p v-if="form.total_free > 0"
                            class="text-right m-0">OP.GRATUITAS: {{ currency_type.symbol }} {{
                                form.total_free
                                                        }}</p>
                        <p v-if="form.total_unaffected > 0"
                            class="text-right m-0">OP.INAFECTAS: {{ currency_type.symbol }}
                                                            {{ form.total_unaffected }}</p>
                        <p v-if="form.total_exonerated > 0"
                            class="text-right m-0">OP.EXONERADAS: {{ currency_type.symbol }}
                                                            {{ form.total_exonerated }}</p>
                        <p v-if="form.total_taxed > 0"
                            class="text-right m-0">OP.GRAVADA: {{ currency_type.symbol }} {{
                                form.total_taxed
                                                        }}</p>
                        <p v-if="form.total_igv > 0"
                            class="text-right m-0">IGV: {{ currency_type.symbol }} {{ form.total_igv }}</p>
                        <h4 v-if="form.total > 0"
                            class="text-right m-0"><b>TOTAL COMPRAS: </b>{{ currency_type.symbol }} {{ form.total }}
                        </h4>
               ...
               <div class="row" v-if="form.has_import && addedInvoices.length">
                   <div class="col-md-12">
                       <div class="table-responsive">
                           <table class="table">
                               <thead>
                               ...
                               <tr v-for="(row, index) in addedInvoices"
                                   ...
                                   <td>{{ index + 1 }}</td>
                                   <td>{{ row.number}}</td>
                                   <td class="text-left">En Transito</td>
                                   <td class="text-right">{{ row.items[0].quantity }}</td>
                                   ...
                                   <td class="text-right">
                                       <button class="btn waves-effect waves-light btn-xs btn-primary"
                                               type="button"
                                               @click.prevent="openPurchaseEditModal(row.id)"><i class="fa fa-edit"></i>
                                       </button>
                                       <button class="btn waves-effect waves-light btn-xs btn-danger"
                                               type="button"
                   ...
                   <div class="col-md-12">
                        <p
                            ...
                            Total EXW: {{ currency_type.symbol }} {{ invoicesTotal }}
                        </p>
                        <p
                            v-if="ladingTotal"
                            class="text-right m-0">
                            Total flete: {{ currency_type.symbol }} {{ladingTotal}}
                        </p>
                        <p
                            v-if="insuranceTotal"
                            class="text-right m-0">
                            Total seguro: {{ currency_type.symbol }} {{ insuranceTotal }}
                        </p>
                        <p
                            v-if="form.fees_settlements.ad_valorem_sol"
                            class="text-right m-0">
                            AD-Valorem: {{ currency_type.symbol }} {{ form.fees_settlements.ad_valorem_sol }}
                        </p>
                        <p
                            v-if="invoicesIgvIpmTotal"
                            class="text-right m-0">
                            (18%) IGV + IPM: {{ currency_type.symbol }} {{ invoicesIgvIpmTotal }}
                        </p>
                        <p
                            v-if="form.fees_settlements.perception_sol"
                            class="text-right m-0">Percepciones: {{ currency_type.symbol }} {{ form.fees_settlements.perception_sol }}
                        </p>
                        <p
                            v-if="invoicesTotal > 0"
                            class="text-right m-0">Costos de nacionalización:{{ currency_type.symbol }} {{ invoicesTotal }}
                        </p>
                         <p
                             v-if="invoicesIgvTotal"
                            class="text-right m-0">
                             IGV Proveedores: {{ currency_type.symbol }} {{ invoicesIgvTotal }}
                         </p>
                    </div>
               </div>
            </div>
            <div class="form-actions text-right mt-4">
                ...
                <el-button v-if="form.items && (form.items.length || addedInvoices.length) && !hide_button"
...
export default {
    props: ['purchase_order_id', 'external', 'recordDataPurchase', 'isImport'],
    components: {
        PurchaseEditDialog,
    ...
    computed: {
        ...
        hasForeignInvoice() {
            return this.form.document_type_id === '15'
        },
        invoicesTotal() {
            const total = this.addedInvoices.map(invoice => invoice.total).reduce((carry, val) => carry += +val, 0);
            return _.round(total, 2);
        },
        invoicesIgvIpmTotal() {
            const igvIpmTotal = this.form.fees_settlements.igv_sol + this.form.fees_settlements.ipm_sol;
            return _.round(parseFloat(igvIpmTotal), 2);
        },
        invoicesIgvTotal() {
            const igvTotal = this.addedInvoices.map(invoice => invoice.total_igv).reduce((carry, val) => carry += +val, 0);
            return _.round(parseFloat(igvTotal), 2);
        },
        ladingTotal() {
            const ladingTotal = this.addedInvoices.map(invoice => {
            ...
            return _.round(parseFloat(ladingTotal), 2);
        },
        insuranceTotal() {
            const insuranceTotal = this.addedInvoices.map(invoice => {
                return invoice.items.map(item => {
                    if (item.item.description === 'SEGURO') {
                        return item.total;
                    }
                })
            }).reduce((carry, val) => carry + val, 0);
            return _.round(parseFloat(insuranceTotal), 2);
        }
    },
    data() {
        return {
    ...
    mounted() {
        ...
        if (this.recordDataPurchase ) {
            this.form.import_order_task = this.recordDataPurchase.import_order_task;
        }
        ...
        this.$http.get(`/${this.resource}/tables`)
            ...
            .then(() => {
                ...
                this.checkDocumentTypeWhenHasImport()
            })
    ...
    methods: {
        ...
        checkDocumentTypeWhenHasImport() {
            if (this.isImport) {
                this.form.document_type_id = this.document_types.find(doc => doc.description === 'FACTURA NO DOMICILIADO (INVOICE)').id
            }
        },
        changeHasGlobalIgv() {
        ...
        initForm() {
            ...
            this.form = {
                ...
                transport_type: '',
                transport_code: '',
                invoice_type: this.form.invoice_type ? this.form.invoice_type : this.recordDataPurchase.type || '',
                note: {
                    series:null,
                    number:null,
                    purchase_id:null,
                ...
                ref_liquidation: '',
                red_customs_agent: '',
                has_import_parent: !!this.isImport,
                import_order_task: '',
                title: '',
                rd_file: null,
                rd_filename: null
        ...
        resetForm() {
            const import_order_task = this.form.import_order_task;
            ...
            this.form.import_order_task = import_order_task;
            this.checkDocumentTypeWhenHasImport();
        ...
        async submit() {
            ...
            this.form.series = this.form.series ? this.form.series : 'n.a.';
            ...
            await this.$http.post(`/${this.resource}`, this.form)
                .then(response => {
                    ...
                    if (response.data.success) {
                        ...
                        this.$emit('addedInvoice', this.form.number)
                        ...
                        if (this.purchase_order_id) {
							...
							this.$eventHub.$emit('savePurchaseNew', {...this.recordDataPurchase, ...response.data.data})

            this.$emit('invoiceAdded', this.form.number);
            this.close()
						}else {
        ...
        deleteInvoice(anInvoiceId) {
            this.delete(`/${this.resource}/delete/${anInvoiceId}`).then(() =>
    ...
    watch: {
        recordDataPurchase(newVal, oldVal) {
            console.log(newVal)
            if (newVal.type) {
                this.form.invoice_type = newVal.type
            }
        }
    }
