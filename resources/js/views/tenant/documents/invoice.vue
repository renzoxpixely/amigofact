                        ...
                        <div class="table-responsive">
                            <table class="table table-sm">
                                ...
                                <tr v-for="(row, index) in form.items"
                                    ...
                                    <td class="text-right">
                                        <template v-if="config.change_free_affectation_igv && row.parent_uuid == null">
                                            <el-tooltip class="item"
                                        ...
                                        <button v-if="row.parent_uuid == null" class="btn waves-effect waves-light btn-xs btn-danger"
                                                type="button"
                                                @click.prevent="clickRemoveItem(index)"><i class="fas fa-trash"></i>
                                        </button>
                                        <!--<button v-if="row.parent_uuid == null" class="btn waves-effect waves-light btn-xs btn-info"
                                                type="button"
