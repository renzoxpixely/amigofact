    ...
    <el-dialog :title="titleDialog" width="40%"  :visible="showDialog"  @open="create"  :close-on-click-modal="false" :close-on-press-escape="false" append-to-body :show-close="false">
        ...
        <div class="form-body">
            <div class="row" >
                ...
                <div class="col-md-12">
                    <el-switch v-model="view_selected" active-text="Ver Seleccionados" @change="changeSelected"></el-switch>
                </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            initForm(){
                const lots = _.map(this.lots, (lot) =>  lot.id)
                this.search = {
                    input: null,
                    item_id: null,
                    document_item_id: this.documentItemId,
                    'lots[]': lots,
                    selected: this.view_selected
                }
