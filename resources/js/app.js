...
Vue.component('purchase-form-new', require('./views/tenant/purchases/components/form_new.vue'));
Vue.component('tenant-purchases-form', require('./views/tenant/purchases/form.vue'));
Vue.component('tenant-purchases-import_purchase', require('./views/tenant/purchases/import_purchase.vue'));
Vue.component('tenant-purchases-import_index', require('./views/tenant/purchases/import_index.vue'));
Vue.component('tenant-purchases-importation_edit', require('./views/tenant/purchases/import_edit.vue'));
...
Vue.component('tenant-item-lots-report', require('../../modules/Item/Resources/assets/js/views/item-lots/report.vue'));
...
//Commercial
Vue.component('tenant-commercials-index', require('@viewsModuleCommercial/commercials/index.vue'));
Vue.component('tenant-commercials-participacion-form', require('@viewsModuleCommercial/commercials/participacion-form.vue'));
Vue.component('tenant-commercials-venta-form', require('@viewsModuleCommercial/commercials/venta-form.vue'));
Vue.component('tenant-commercials-renta-form', require('@viewsModuleCommercial/commercials/renta-form.vue'));
// Vue.component('tenant-commercials-view', require('@viewsModuleCommercial/commercials/view'));


//Logistic
Vue.component('tenant-logistics-index', require('@viewsModuleLogistic/logistics/index.vue'));
Vue.component('tenant-logistics-form', require('@viewsModuleLogistic/logistics/form.vue'));

//Contractor
Vue.component('tenant-contracts-index', require('@viewsModuleContract/contracts/index.vue'));
Vue.component('tenant-contracts-form', require('@viewsModuleContract/contracts/form.vue'));
Vue.component('tenant-contracts-view', require('@viewsModuleContract/contracts/view.vue'));
Vue.component('tenant-contract-types-index', require('@viewsModuleContract/contract_types/index.vue'));
Vue.component('tenant-production-orders-index', require('@viewsModuleContract/production_orders/index.vue'));
