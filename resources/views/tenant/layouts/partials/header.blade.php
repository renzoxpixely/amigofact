<header class="header">
    ...
    <div class="header-right">
        <a href="https://qipuh.com/soporte" target="_blank">
            <div class="switch switch-sm switch-primary" data-toggle="tooltip" data-placement="bottom" title="Soporte">
                <img src="{{asset("/logo/ico-q.png")}}" alt="">
            </div>
        </a>
