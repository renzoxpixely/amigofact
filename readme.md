...
## Posibles problemas
* Para aplicar un migration a un tenancy se debe hacer de la siguente manera: 
```
php artisan tenancy:migrate
```

* En caso de un *Javascript Heap Out Of Memory* (windows)

    - Ir al panel de control
    - Ir a Configuración Avanzada del sistema
    - Haz clic en variables de entorno
    - En la parte de vairables del sistema hacer clic en nuevo
    - Pon *NODE_OPTIONS* como nombre del variable
    - Pon *--max-old-space-size=4096* como valor
    - Guarda los cambios y reinicia el proyecto y el terminal
## AQPFACT - Peru
