...
class ItemLot extends ModelTenant
{
    ...
    public function setGameId($game_id): self {
        $this->game_id = $game_id;

        return $this;
    }

    public function setMinceturCode($mincetur_code) {
        $this->mincetur_code = $mincetur_code;
    ...
    public function contract_item_lot(){
        return $this->belongsTo(ContractItemLot::class, 'id', 'item_lot_id');
    }
