    ...
    Route::domain($hostname->fqdn)->group(function () {
        Route::middleware(['auth', 'locked.tenant'])->group(function() {
            ...
            Route::prefix('item-lots')->group(function () {
                ...
                Route::get('/report-index', 'ItemLotController@reportIndex')->name('tenant.item-lots.report');
                Route::get('/report-records', 'ItemLotController@importationSeriesReportRecords');
                Route::get('report-records-export', 'ItemLotController@exportImportationSeriesReport');
                ...
                Route::get('/tables', 'ItemLotController@tables');
