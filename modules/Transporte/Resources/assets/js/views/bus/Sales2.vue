                ...
                <div>
                    <table class="mx-auto">
                        <tr v-for="idxr, r in rows">
                            <td v-for="idxc, c in cols" class="pl-2" style="width: 70px">

                                <svg @click="onSeatSelected(idxr, idxc)" v-if="!isAisle(idxr, idxc)" id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
