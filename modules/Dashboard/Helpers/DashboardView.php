...
class DashboardView
{
    public static function getEstablishments($isAll = false)
    {
		...
		if($establishments){
			$newEstab = ['id' => 0, 'name' => 'Seleccionar Todos'];
			$establishments = $establishments->add($newEstab)->sortBy('id')->values()->all();
		}
