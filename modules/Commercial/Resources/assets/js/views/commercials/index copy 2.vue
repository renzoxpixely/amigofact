    ...
    <div>
        ...
        <div class="card mb-0">
            ...
            <!-- <persons-form :api_service_token="api_service_token"
                          ...
                          :type="type"
                          @clickUser="clickUser"></persons-form>
            ...
            <users-form :showDialog.sync="showDialogUser"
                        :typeUser="typeUser"
                        :typeUserSelected="'client'"
						:external="true"
                        :recordId="recordUserId"></users-form> -->
...
// import UsersForm from '../users/form1.vue'
...
export default {
    ...
    mounted() {
        // Imprimir la data del componente
        console.log('Title:', this.title);
        console.log('showDialog:', this.showDialog);
        console.log('showDialogUser:', this.showDialogUser);
        console.log('showImportDialog:', this.showImportDialog);
        console.log('showExportDialog:', this.showExportDialog);
        console.log('resource:', this.resource);
        console.log('recordId:', this.recordId);
        console.log('recordUserId:', this.recordUserId);
