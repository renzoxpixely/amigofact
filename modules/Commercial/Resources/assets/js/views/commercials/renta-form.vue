<template>
    <div class="card mb-0 pt-2 pt-md-0 negrita">
        <div class="card-header bg-info">
            <h3 class="my-0">Cotización Renta</h3>
        </div>
    ...
    <label class="control-label">DIAS DE CONTRATO</label>
    <el-input v-model="form.months" :clearable="true" placeholder="Dias"></el-input>
