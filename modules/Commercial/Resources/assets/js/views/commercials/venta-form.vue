<template>
    <div class="card mb-0 pt-2 pt-md-0 negrita">
        <div class="card-header bg-info">
            <h3 class="my-0">Cotización Venta</h3>
        </div>
    ...
    <div class="font-weight-bold">Aceptado</div>
                ...
                <form autocomplete="off" @submit.prevent="submit">
                    <div class="form-body">
                        <div class="row mt-1">
                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="form-group col-lg-6" :class="{'has-danger': errors.customer_participation}">
                                    ...
                                    <div class="d-flex">
                                        <el-radio v-model="selectedType" label="porcentual">Porcentual</el-radio>
                                        <el-radio v-model="selectedType" label="monto_fijo">Monto fijo</el-radio>
                                    </div>
                                </div>
                                <div  class="form-group col-lg-6" :class="{'has-danger': errors.customer_participation}">
                                    <label class="control-label">Monto</label>
                                    <el-input v-model="form.customer_participation" :clearable="true" v-if="selectedType === 'porcentual'" placeholder="%"></el-input>
                                    <el-input v-model="form.customer_participation" :clearable="true" v-else placeholder="Monto"></el-input>
                        ...
                        <div class="row mt-1">
                            ...
                            <div class="col-lg-3">
                                <div class="form-group" :class="{'has-danger': errors.customer_participation}">
                                    ...
                                    <el-input v-model="form.customer_participation" :clearable="true" placeholder="Cuota"></el-input>
                                    <small class="form-control-feedback" v-if="errors.customer_participation" v-text="errors.customer_participation[0]"></small>
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="form-group" :class="{'has-danger': errors.customer_participation}">
                                    ...
                                    <el-input v-model="form.customer_participation" :clearable="true" placeholder="Cantidad"></el-input>
                                    <small class="form-control-feedback" v-if="errors.customer_participation" v-text="errors.customer_participation[0]"></small>
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="form-group" :class="{'has-danger': errors.customer_participation}">
                                    <label class="control-label">Porcentaje de Intereses</label>
                        ...
                        <div class="col-lg-12 col-md-6 d-flex align-items-end mt-3">
                            <div class="form-group">
                                    ...
                                    <table class="table">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-center font-weight-bold">DSCTO</th>
                                                <th class="text-right font-weight-bold">Subtotal</th>
                                                <!--<th class="text-right font-weight-bold">Cargo</th>-->
                                                <th class="text-right font-weight-bold">Total</th>
                                                <th class="text-right font-weight-bold">OPTION</th>
                                            </tr>
                                        </thead>
