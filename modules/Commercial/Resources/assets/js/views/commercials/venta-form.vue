                ...
                <form autocomplete="off" @submit.prevent="submit">
                    <div class="form-body">
                        ...
                        <div class="row mt-1">
                            ...
                            <div class="col-lg-3">
                                <div class="form-group" :class="{'has-danger': errors.customer_participation}">
                                    ...
                                    <el-input v-model="form.initial_payment" :clearable="true" placeholder="Cuota"></el-input>
                                    <small class="form-control-feedback" v-if="errors.customer_participation" v-text="errors.customer_participation[0]"></small>
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="form-group" :class="{'has-danger': errors.customer_participation}">
                                    ...
                                    <el-input v-model="form.installment_count" :clearable="true" placeholder="Cantidad"></el-input>
                                    <small class="form-control-feedback" v-if="errors.customer_participation" v-text="errors.customer_participation[0]"></small>
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="form-group" :class="{'has-danger': errors.customer_participation}">
                                    ...
                                    <el-input v-model="form.interest_percentage" :clearable="true" placeholder="%"></el-input>
                                    <small class="form-control-feedback" v-if="errors.customer_participation" v-text="errors.customer_participation[0]"></small>
                                </div>
                            </div>     
                        ...
                        <div class="row mt-1">
                            ...
                            <div class="col-lg-8 mt-2" v-if="showPayments && !form.quotation_id && contractTypeName == 'venta'">
                            ...
                            <!-- <div class="col-12 pt-3">
                                <div class="row">
                                    ...
                                    <div class="form-group col-12 col-md-6">
                                        <label class="invisible">Cláusulas</label>
...
<script>
    ...
    this.form.items.forEach((row) => {
        ...
        switch (row.affectation_igv_type_id) {
            case '10':
