    ...
    class MovementCollection extends ResourceCollection
    {
        ...
        public function toArray($request)
        {
            ...
            $data = $this->collection->transform(function (GlobalPayment $row, $key) use ($request) {
                ...
                $timedate = $date_of_payment ? $date_of_payment->toDateTimeString() : null;
                $document_type = '';
                ...
                if (isset($payment->associated_record_payment->document_type)) {
                ...
                return [
                    ...
                    'currency_type_id' => $payment->associated_record_payment->currency_type_id??null,
        ...
        public function getPaymentMethodTypeDescription($row)
        {
            ...
            if (isset($row->payment->payment_method_type)) {

                $payment_method_type_description = $row->payment->payment_method_type->description;

            } else if(isset($row->payment->expense_method_type->description)){
        ...
        public function getDocumentTypeDescription($row)
        {
            ...
            if (isset($row->payment->associated_record_payment->document_type)) {
