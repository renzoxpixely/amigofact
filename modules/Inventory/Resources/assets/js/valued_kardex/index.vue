            ...
            <div class="card-body">
                ...
                <data-table :resource="resource">
                    ...
                    <tr slot-scope="{ index, row }">
                        ...
                        <td class="text-center">{{ calculateCostUnit(row.warehouses) }}</td>
...
export default {
    ...
    methods: {
        ...
        calculateCostUnit(warehouses) {
            let costs = 0
            if(warehouses && warehouses.length > 0){
                warehouses.forEach(element => {
                    costs += parseFloat(element.sale_unit_price)
                });
                costs = _.round(costs / warehouses.length, 2)
            }
            return costs
        }
    }
