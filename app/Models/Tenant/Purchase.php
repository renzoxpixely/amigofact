...
class Purchase extends ModelTenant
{
    ...
    const INVOICE_TYPE_LADING = 'lading';
    const INVOICE_TYPE_INSURANCE = 'insurance';
    ...
    protected $fillable = [
        ...
        'total_insurace',
        'total_cost',
        'total_tax_customs_law',
        'total_tax_isc',
        'total_tax_igv',
        'total_tax_ipm',
        'total_tax_customs_fee',
        'total_tax_rights',
        'total_tax_perception',
        'total_import_expenses_without_igv',
        'total_igv_expenses_usd',
        'total_ipm_expenses_usd',
    ...
    public function getLadingAttribute($value)
    {
        return (is_null($value))?null:(object) json_decode($value);
    }

    public function setLadingAttribute($value)
    {
        $this->attributes['lading'] = (is_null($value))?null:json_encode($value);
    }

    public function getInsuraceAttribute($value)
    {
        return (is_null($value))?null:(object) json_decode($value);
    }

    public function setInsuraceAttribute($value)
    {
        $this->attributes['insurace'] = (is_null($value))?null:json_encode($value);
    }

    public function getImportCostsAttribute($value)
    {
        return (is_null($value))?null:(object) json_decode($value);
    }

    public function setImportCostsAttribute($value)
    {
        $this->attributes['import_costs'] = (is_null($value))?null:json_encode($value);
    }

    public function getFeesSettlementsAttribute($value)
    {
        return (is_null($value))?null:(object) json_decode($value);
    }

    public function setFeesSettlementsAttribute($value)
    {
        $this->attributes['fees_settlements'] = (is_null($value))?null:json_encode($value);
    }
    ...
    public function items_prorated_by_ad_valorem()
    {
        return $this->hasMany(PurchaseItem::class)->where('prorated_by_ad_valorem', true);
    }

    public function items_prorated_by_weight()
    {
        return $this->hasMany(PurchaseItem::class)->where('prorated_by_weight', true);
    }

    public function items_prorated_by_cost()
    {
        return $this->hasMany(PurchaseItem::class)->where('prorated', true);
    }
}
