...
class PurchaseItem extends ModelTenant
{
    ...
    protected $with = ['affectation_igv_type', 'system_isc_type', 'price_type', 'lots', 'warehouse', 'sub_items'];
    ...
    protected $casts = [
        'prorated' => 'boolean',
        'prorated_by_ad_valorem' =>  'boolean',
        'prorated_by_weight' =>  'boolean',
        'is_subitem' => 'boolean',
    ];
    ...
    {
        $this->attributes['detail'] = (is_null($value))?null:json_encode($value);
    }

    public function getMinceturAttribute($value)
    {
        return (is_null($value))?null:(object) json_decode($value);
    }

    public function setMinceturAttribute($value)
    {
        $this->attributes['mincetur'] = (is_null($value))?null:json_encode($value);
    }
    ...
    {
        return $this->hasMany(PurchaseItem::class, 'parent_id', 'id');
    }
}
