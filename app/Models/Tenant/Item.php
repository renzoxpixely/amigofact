...
{
    protected $with = ['item_type', 'unit_type', 'currency_type', 'warehouses','item_unit_types', 'tags', 'category'];
    protected $fillable = [
        'warehouse_id',
        'name',
        'second_name',
     ...
     * @return Builder
     */
    public function scopeWhereNullParent($query)
    {
 ...
 *
    ...
    public function getDataToItemModal(
        ...
        $data = [
            ...
            'sub_items' => $this->subItems->transform(function ($row) use ($warehouse){
                /*return [
                    'id' => $row->id,
            ...
            'mincetur_code' => $this->mincetur_game_code
        ];
    ...
    * $Situacion = $row[10];
    ...
    public static function createServiceItem($description, $currency_type_id)
    {
        ...
        $data = [
            ...
            "item_warehouse_prices" => $item_warehouse_prices,
            "annual_depreciation" => 0.01,
            "sub_items" => [],
            "parent_id" => null,
            "is_sub_item" => false
        ];
        ...
        return $itemController->store($request);
    }
