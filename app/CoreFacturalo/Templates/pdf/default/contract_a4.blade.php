...
<table class="full-width mt-5">
    ...
    <tr>
        <td class="align-top">Tipo Contrato:</td>
        <td colspan="3">
...
<table class="full-width mt-10 mb-10">
    ...
    <tr class="bg-grey">
        ...
        <th class="border-top-bottom text-left py-2">SALA</th>
        ...
        <tr>
            ...
            <td class="text-left">
                ...
                @foreach($row->lots as $lot)
                    <br/><span style="font-size: 9px">{{ $lot->item_lot->series }}</span>
                @endforeach

            </td>
            <td class="text-left align-top">{{ $row->hall->name ?? '-' }}</td>
