...
use Carbon\Carbon;
    ...
    class ClientController extends Controller
    {
        ...
        public function store(ClientRequest $request)
        {
            ...
            $establishment_customer = DB::connection('tenant')->table('establishments')->insert([
                'id' => Establishment::ESTABLISHMENT_CUSTOMER_ID,
                'description' => 'Establecimiento de Clientes',
                'country_id' => 'PE',
                'department_id' => '15',
                'province_id' => '1501',
                'district_id' => '150101',
            ...
            $establishment_contract = DB::connection('tenant')->table('establishments')->insert([
                'id' => Establishment::ESTABLISHMENT_CONTRACT_ID,
                'description' => PersonHall::HALL_CONTRACT_NAME,
                'country_id' => 'PE',
                'department_id' => '15',
                'province_id' => '1501',
                'district_id' => '150101',
            ...
            DB::connection('tenant')->table('warehouses')->insertGetId([
                'id' => Warehouse::WAREHOUSE_CONTRACT_ID,
                'establishment_id' => Establishment::ESTABLISHMENT_CONTRACT_ID,
                'description' => PersonHall::HALL_CONTRACT_NAME,
                'created_at' => now(),
                'updated_at' => now(),
            ]);

            DB::connection('tenant')->table('person_halls')->insertGetId([
                'id' => PersonHall::HALL_CONTRACT_ID,
                'person_id' => null,
                'name' => PersonHall::HALL_CONTRACT_NAME,
                'department_id' => '15',
                'province_id' => '1501',
                'district_id' => '150101',
                'address' => '-',
                'warehouse_id' => Warehouse::WAREHOUSE_CONTRACT_ID
            ]);
