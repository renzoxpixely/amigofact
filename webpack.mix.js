...
mix.webpackConfig({
    resolve: {
        alias: {
            ...
            '@viewsModuleCommercial': path.resolve(__dirname, 'modules/Commercial/Resources/assets/js/views'),
            '@viewsModuleLogistic': path.resolve(__dirname, 'modules/Logistic/Resources/assets/js/views'),
            '@viewsModuleContract': path.resolve(__dirname, 'modules/Contract/Resources/assets/js/views'),
			'@viewsModuleSuscription': path.resolve(__dirname, 'modules/Suscription/Resources/assets/js'),
