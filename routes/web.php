...
if ($hostname) {
    Route::domain($hostname->fqdn)->group(function () {
        ...
        Route::middleware(['auth', 'redirect.module', 'locked.tenant'])->group(function () {
            ...
            Route::post('items/rd-file', 'Tenant\ItemController@uploadRdFile');
            ...
            Route::get('purchases/import', 'Tenant\PurchaseController@createImport')->name('tenant.purchases.import');
            Route::get('purchases/import-index', 'Tenant\ImportationController@importIndex')->name('tenant.purchases.import-index');
            ...
            Route::post('purchases/import-cost/upload', 'Tenant\PurchaseController@uploadAttached');
            ...
            // Importation
            Route::post('importation', 'Tenant\ImportationController@store');
            Route::get('importation/edit/{id}', 'Tenant\ImportationController@edit');
            Route::post('importation/{importation}', 'Tenant\ImportationController@update');
            Route::delete('importation/{importation}', 'Tenant\ImportationController@destroy');
            Route::get('importation/records', 'Tenant\ImportationController@records');
            Route::get('importation/columns', 'Tenant\ImportationController@columns');
            Route::get('importation/export', 'Tenant\ImportationController@export');
            Route::get('importation/{importation}', 'Tenant\ImportationController@show');
            Route::get('importation/{importation}/parent-report', 'Tenant\ImportationController@parentReport');
            Route::get('importation/{importation}/parent-report/export', 'Tenant\ImportationController@parentReportExport');
            ...
            Route::delete('purchases/{purchase}', 'Tenant\PurchaseController@delete');
            Route::delete('purchases/destroy_purchase_item/{purchase_item}', 'Tenant\PurchaseController@destroy_purchase_item');
